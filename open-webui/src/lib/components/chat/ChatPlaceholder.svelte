<script lang="ts">
	...
	const suggestions = [
		{
			title: '학과정보',
			subtitle: "컴퓨터공학과에 대해 알려주세요",
			prompt: "컴퓨터공학과에 대해 알려주세요"
		},
		{
			title: '수업추천',
			subtitle: '1학년 1학기에 들을만한 수업 추천해줘',
			prompt: '1학년 1학기에 들을만한 수업 추천해줘'
		},
		{
			title: '교수님 검색',
			subtitle: '김철수 교수님은 어떤 수업을 하시나요?',
			prompt: '김철수 교수님은 어떤 수업을 하시나요?'
		}
	];
